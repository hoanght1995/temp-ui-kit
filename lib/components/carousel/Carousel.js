...
var Carousel = (0, react_1.forwardRef)(function (props, ref) {
    ...
    var pages = (0, react_1.useMemo)(function () {
        return data.map(function (item, index) {
            return function (_a) {
                var style = _a.style;
                return react_1.default.createElement(native_1.animated.View, { style: __assign({}, style) }, renderItem(item, index));
            };
        });
    }, [data]);
    ...
    var transitions = (0, native_1.useTransition)(index, {
        ref: transRef,
        from: { opacity: 0, left: reverse ? "-100%" : "100%", position: "absolute" },
    ...
    return (react_1.default.createElement(react_native_1.View, { style: styles.container },
        react_1.default.createElement(react_native_1.View, __assign({ style: styles.container }, panResponder.panHandlers),
            react_1.default.createElement(react_native_1.View, { style: styles.slides }, transitions(function (style, i) {
                var Page = pages[i];
                return react_1.default.createElement(Page, { style: __assign(__assign({}, style), styles.slide), key: i });
            })),
            showControl && react_1.default.createElement(Control_1.default, { handleControlClick: handleControlClick })),
        showIndicator
            && react_1.default.createElement(Indicator_1.default, { indicatorQuantity: pages.length, activeIndex: index, onChangeIndicator: onChangeIndicator })));
});
