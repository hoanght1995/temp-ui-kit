...
function Indicator(props) {
    ...
    return (react_1.default.createElement(react_native_1.View, { style: styles.indicator }, dots.map(function (props, index) { return (react_1.default.createElement(react_native_1.TouchableOpacity, { key: index, onPress: function () { return onChangeIndicator(index); }, testID: "indicator-".concat(index + 1) },
