...
var SegmentTab = (0, react_1.forwardRef)(function (props, ref) {
    var _a;
    var tabs = props.tabs, style = props.style, size = props.size, initTabIndex = props.initTabIndex, currentTab = props.currentTab, onChangeTab = props.onChangeTab, onChangeTabEnd = props.onChangeTabEnd, _b = props.fullWidth, fullWidth = _b === void 0 ? false : _b, containerBackgroundColor = props.containerBackgroundColor, innerBackgroundColor = props.innerBackgroundColor, textColor = props.textColor, restProps = __rest(props, ["tabs", "style", "size", "initTabIndex", "currentTab", "onChangeTab", "onChangeTabEnd", "fullWidth", "containerBackgroundColor", "innerBackgroundColor", "textColor"]);
    ...
    var springProps = (0, native_1.useSpring)({
        ...
        onRest: {
            left: function () {
                onChangeTabEnd && onChangeTabEnd(selectedTab);
            }
        }
    });
