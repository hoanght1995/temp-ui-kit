...
var svg_1 = require("../../utils/svgs/svg");
var Icon = function (props) {
    var color = props.color, style = props.style, size = props.size, name = props.name, width = props.width, height = props.height;
    var SvgComponent = react_1.default.useMemo(function () { return (0, svg_1.loadSVG)(name); }, [name]);
    ...
    return (react_1.default.createElement(react_native_1.View, { style: style },
        react_1.default.createElement(react_1.Suspense, { fallback: null },
            react_1.default.createElement(SvgComponent, __assign({}, (0, lodash_1.omitBy)({
                fill: color,
                width: icWidth,
                height: icHeight,
