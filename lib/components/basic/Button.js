...
var TYPES = {
    primary: {
        container: {
            backgroundColor: constants_1.COLORS.primaryA,
        },
        hoverContainer: {
            backgroundColor: constants_1.COLORS.darkPurple100,
        },
        title: {
    ...
    light: {
        ...
        hoverContainer: {
            backgroundColor: constants_1.COLORS.gray50,
        },
        title: {
            color: constants_1.COLORS.text800,
        },
        spin: {
            color: constants_1.COLORS.purple,
        },
    },
    text: {
        container: {},
