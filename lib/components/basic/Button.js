...
var getStyleByType = function (color) { return ({
    primary: {
        container: {
            backgroundColor: color || utils_1.COLORS.primaryA,
        },
        hoverContainer: {
            backgroundColor: color || utils_1.COLORS.darkPurple100,
        },
        title: {
    ...
    light: {
        ...
        title: {
            color: color || utils_1.COLORS.text800,
        },
        spin: {
            color: color || utils_1.COLORS.purple,
        },
    },
    text: {
        container: {},
...
var Button = function (props) {
    var _a;
    var style = props.style, children = props.children, title = props.title, onRef = props.onRef, disable = props.disable, loading = props.loading, size = props.size, type = props.type, shape = props.shape, left = props.left, right = props.right, titleStyle = props.titleStyle, color = props.color, restProps = __rest(props, ["style", "children", "title", "onRef", "disable", "loading", "size", "type", "shape", "left", "right", "titleStyle", "color"]);
    var _b = (0, hooks_1.useHover)(), _c = _b[0], hoverProps = _c === void 0 ? {} : _c, isHovered = _b[1];
    var styleBySize = SIZES[size || "md"];
    var styleByType = (_a = getStyleByType(color)) === null || _a === void 0 ? void 0 : _a[type || "primary"];
    var combineStyles = [
        styles.container,
    ...
    return (react_1.default.createElement(react_native_1.Pressable, __assign({}, hoverProps, restProps, { disabled: disable, style: combineStyles }),
        Boolean(left) &&
            react_1.default.createElement(react_native_1.View, { style: { marginRight: shape ? 0 : 6 } }, left),
        Boolean(title) &&
            react_1.default.createElement(RText_1.default, { numberOfLines: 1, title: title, type: styleBySize[2], style: [styleByType.title, titleStyle] }),
        Boolean(right) &&
