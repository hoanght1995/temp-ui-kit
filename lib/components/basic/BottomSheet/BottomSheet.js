                    ...
                    react_1.default.createElement(AnimatedPressable, { style: bottomSheetStyle, testID: testID },
                        ...
                        react_1.default.createElement(react_native_1.View, __assign({}, panResponder.panHandlers, { style: styles.content }),
                            showTopHandler && (react_1.default.createElement(react_native_1.View, { style: styles.header },
                                react_1.default.createElement(react_native_1.View, { style: styles.titleContainer }, Boolean(title) && (react_1.default.createElement(RText_1.default, { testID: "modal-dialog-title", ellipsizeMode: "tail", type: "l2b", numberOfLines: 1 }, title))),
                                react_1.default.createElement(react_native_1.Pressable, { onPress: onClose, style: styles.closeBtn },
                                    react_1.default.createElement(Icon_1.default, { name: "close", size: 20 })))),
                            react_1.default.createElement(Body, { style: [styles.body, !showTopHandler && styles.roundedTopBody, bodyStyle], scroll: scroll, testID: "modal-dialog-body" }, children),
