...
var DEFAULT_HEIGHT = SCREEN_HEIGHT / 2;
var MAX_HEIGHT = SCREEN_HEIGHT * 0.9;
var EXTRA_BOTTOM_HEIGHT = 100;
var DRAG_THRESHOLD = 60;
var MAX_UPWARD = 40;
var Body = function (_a) {
    var children = _a.children, style = _a.style, scroll = _a.scroll;
    return scroll ? (react_1.default.createElement(react_native_1.ScrollView, { style: style },
        react_1.default.createElement(react_native_1.TouchableWithoutFeedback, null, children))) : (react_1.default.createElement(react_native_1.View, { style: style }, children));
};
var BottomSheet = (0, react_1.forwardRef)(function (_a, ref) {
    var testID = _a.testID, title = _a.title, propOnClose = _a.onClose, children = _a.children, actionButtons = _a.actionButtons, _b = _a.backDropClosable, backDropClosable = _b === void 0 ? true : _b, _c = _a.showTopHandler, showTopHandler = _c === void 0 ? true : _c, _d = _a.scroll, scroll = _d === void 0 ? false : _d, _e = _a.height, height = _e === void 0 ? DEFAULT_HEIGHT : _e, bodyStyle = _a.bodyStyle;
    testID = testID ? "".concat(testID, "-modal-backdrop") : undefined;
    var _f = (0, react_1.useState)(false), visible = _f[0], setVisible = _f[1];
    var caculatedHeight = (height === "100%" || height > MAX_HEIGHT) ? MAX_HEIGHT : height;
    ...
    var onClose = (0, react_1.useCallback)(function (e, force) {
        if (!visible && !force)
            return;
    ...
    return (react_1.default.createElement(react_native_1.Modal, { transparent: true, visible: visible, onRequestClose: onClose },
        ...
        react_1.default.createElement(react_native_1.Pressable, { testID: testID, style: styles.backDrop, onPress: onBackDropClose },
            react_1.default.createElement(react_native_1.SafeAreaView, { style: styles.safeArea },
                react_1.default.createElement(KeyboardAvoider, { behavior: "padding", style: styles.keyboardAvoider },
                    react_1.default.createElement(AnimatedPressable, { style: bottomSheetStyle },
                        react_1.default.createElement(react_native_1.View, __assign({}, panResponder.panHandlers, { style: styles.content }),
                            showTopHandler && (react_1.default.createElement(react_native_1.View, { style: styles.header },
                                react_1.default.createElement(react_native_1.View, { style: styles.handler }),
                                !!title && (react_1.default.createElement(RText_1.default, { ellipsizeMode: "tail", type: "l2b", numberOfLines: 1, style: styles.title }, title)))),
                            react_1.default.createElement(Body, { style: [styles.body, bodyStyle], scroll: scroll }, children),
                            actionButtons && (react_1.default.createElement(react_native_1.View, { style: styles.footer }, actionButtons.map(function (button, index) { return (react_1.default.createElement(Button_1.default, __assign({ key: index }, button, { style: __assign(__assign({}, button.style), { flex: 1, marginRight: actionButtons.length - 1 > index ? 15 : 0 }) }))); })))),
