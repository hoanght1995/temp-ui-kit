...
var Body = function (_a) {
    ...
    return scroll ? (react_1.default.createElement(react_native_1.ScrollView, { style: style, testID: testID },
        react_1.default.createElement(react_native_1.TouchableWithoutFeedback, null, children))) : (react_1.default.createElement(react_native_1.View, { style: style, testID: testID }, children));
};
