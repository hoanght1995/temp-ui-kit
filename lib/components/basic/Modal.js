...
var ModalComponent = (0, react_1.forwardRef)(function (_a, ref) {
    ...
    if (!visible)
        return null;
    return (react_1.default.createElement(react_native_1.Modal, { presentationStyle: "overFullScreen", transparent: true, visible: true, onRequestClose: function () { return onClose(); } },
