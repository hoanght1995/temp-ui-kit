...
var ModalComponent = (0, react_1.forwardRef)(function (_a, ref) {
    ...
    var _h = (0, native_1.useSpring)(function () { return ({
        backDropOpacity: 0,
        modalScale: 0.9,
    }); }), _j = _h[0], backDropOpacity = _j.backDropOpacity, modalScale = _j.modalScale, springHelpers = _h[1];
    ...
    var onClose = (0, react_1.useCallback)(function (onFinish) {
        if (!visible)
            return;
        springHelpers.start({
            backDropOpacity: 0,
    ...
    }, [animation, visible, springHelpers, propOnClose]);
    ...
    if (!visible)
        return null;
    return (react_1.default.createElement(react_native_1.Modal, { transparent: true, visible: true, onRequestClose: function () { return onClose(); } },
        react_1.default.createElement(KeyboardAvoider, { behavior: "padding", style: styles.keyboardAvoider },
            react_1.default.createElement(AnimatedPressable, { testID: backdropTestID, style: [backDropStyle, centered && styles.centered], onPress: onBackDropClose },
                react_1.default.createElement(react_native_1.ScrollView, { centerContent: centered, style: styles.scroll, contentContainerStyle: [styles.scrollContentContainer, !centered && styles.scrollContentContainerPaddingTop], contentInsetAdjustmentBehavior: "automatic", keyboardShouldPersistTaps: "handled" },
                    react_1.default.createElement(AnimatedPressable, { style: modalStyle, testID: testID },
                        Boolean(title || onBack || (headerButtons === null || headerButtons === void 0 ? void 0 : headerButtons.length)) && (react_1.default.createElement(react_native_1.View, { style: styles.header },
                            ...
                            react_1.default.createElement(react_native_1.View, { style: styles.headerRight }, headerButtons === null || headerButtons === void 0 ? void 0 :
                                ...
                                closable && (react_1.default.createElement(react_native_1.TouchableOpacity, { testID: "modal-close", onPress: function () { return onClose(); }, style: styles.headerRightButton, hitSlop: hitSlop },
                                    react_1.default.createElement(Icon_1.default, { name: "close", size: 25 })))))),
                        react_1.default.createElement(react_native_1.View, { style: [styles.body, bodyStyle], testID: "modal-dialog-body" }, children),
                        !(0, lodash_1.isEmpty)(actionButtons) && (react_1.default.createElement(react_native_1.View, { style: styles.footer, testID: "modal-dialog-action" }, actionButtons === null || actionButtons === void 0 ? void 0 : actionButtons.map(function (button, index) { return (react_1.default.createElement(Button_1.default, __assign({ key: index }, button, { style: [button.style, {
...
var styles = react_native_1.StyleSheet.create({
    ...
    scrollContentContainerPaddingTop: {
        paddingTop: platform_1.isWeb ? 50 : 0
    },
    title: {
        flex: 1
    },
