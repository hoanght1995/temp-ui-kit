...
var RTextInput = function (_a) {
    var style = _a.style, size = _a.size, label = _a.label, info = _a.info, left = _a.left, right = _a.right, actionButton = _a.actionButton, disabled = _a.disabled, readOnly = _a.readOnly, error = _a.error, _b = _a.fluid, fluid = _b === void 0 ? true : _b, props = __rest(_a, ["style", "size", "label", "info", "left", "right", "actionButton", "disabled", "readOnly", "error", "fluid"]);
    ...
    return (react_1.default.createElement(react_native_1.View, { style: [style, styles.outer, fluid && styles.fluid] },
        (!!label || !!info) && (react_1.default.createElement(react_native_1.View, { style: styles.titleBox },
            ...
            !!info && (react_1.default.createElement(react_native_1.TouchableOpacity, null,
                react_1.default.createElement(Icon_1.default, { name: "circle-info", size: 17.5 }))))),
        react_1.default.createElement(react_native_1.View, { style: textInputBoxStyle },
            ...
            react_1.default.createElement(react_native_1.TextInput, __assign({}, props, { editable: !disabled && !readOnly, placeholderTextColor: constants_1.COLORS.text200, onBlur: onBlur, onFocus: onFocus, style: styles.textInput })),
...
var styles = react_native_1.StyleSheet.create({
    ...
    textInputBox: {
        borderWidth: 1,
        borderColor: constants_1.COLORS.gray200,
        height: 40,
    ...
    focus: {
        borderColor: constants_1.COLORS.purple,
        shadowColor: constants_1.COLORS.purple,
        shadowOffset: {
            width: 0,
            height: 1,
        },
        ...
        shadowRadius: 1.41,
        elevation: 2,
        outlineColor: constants_1.COLORS.lightPurple800,
        outlineStyle: "solid",
    },
    readOnly: {
        backgroundColor: constants_1.COLORS.violet100,
        borderColor: constants_1.COLORS.violet100
    },
    error: {
        borderColor: constants_1.COLORS.red500,
    },
    disabled: {
        backgroundColor: constants_1.COLORS.gray300,
        borderColor: constants_1.COLORS.gray300,
        opacity: 0.5
    },
    textInput: {
        height: "100%",
    ...
    actionButton: {
        marginRight: 6,
        backgroundColor: constants_1.COLORS.violet40,
        borderWidth: 0
    },
    errorText: {
        color: constants_1.COLORS.red500,
        marginTop: 3
    },
    leftElement: {
        marginLeft: 6,
