...
var RTextInput = function (_a) {
    ...
    return (react_1.default.createElement(react_native_1.View, { style: [style, styles.outer, fluid && styles.fluid] },
        ...
        react_1.default.createElement(react_native_1.View, { style: textInputBoxStyle },
            ...
            react_1.default.createElement(react_native_1.TextInput, __assign({}, props, { editable: !disabled && !readOnly, placeholderTextColor: utils_1.COLORS.text200, onBlur: onBlur, onFocus: onFocus, style: styles.textInput })),
...
var styles = react_native_1.StyleSheet.create({
    ...
    focus: {
        ...
        shadowColor: utils_1.COLORS.purple,
        shadowOffset: {
            width: 0,
            height: 1,
        },
