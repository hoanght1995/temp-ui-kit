...
var Accordion = function (props) {
    ...
    return (react_1.default.createElement(native_1.animated.View, { style: [styles.container, { overflow: open ? "scroll" : "hidden" }] },
        react_1.default.createElement(react_native_1.Pressable, { style: styles.header, onPress: toggle },
            title
        ...
        collapseAnimation(function (style, item) { return (item &&
            react_1.default.createElement(native_1.animated.View, { style: [style, styles.panel], onLayout: onLayout }, content
