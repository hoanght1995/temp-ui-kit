...
var index_native_1 = __importDefault(require("../../assets/svgs/index.native"));
var loadSVG = function (fileName, defaultIcon) { return function (props) {
    var SvgComponent = index_native_1.default[fileName];
    if (!SvgComponent && defaultIcon)
        SvgComponent = index_native_1.default[defaultIcon];
    if (SvgComponent)
